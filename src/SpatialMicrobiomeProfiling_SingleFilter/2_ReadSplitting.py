...
save_barcode_path = f"data/processed/SingleFilter/{sample_name}/barcode_tsv/"

# Directory for splitted fastq files of non-human reads
splitted_fastq_dir = f"data/processed/SingleFilter/{sample_name}/splitted_fastq/"
...
def run_cmd_umi(barcode):
    ...
    --stdin data/processed/SingleFilter/{sample_name}/nonhuman_read/nonhuman_reads.1.fa \
    --stdout {splitted_fastq_dir}/{barcode}_R1.fastq \
    --read2-in data/processed/SingleFilter/{sample_name}/nonhuman_read/nonhuman_reads.2.fa \
